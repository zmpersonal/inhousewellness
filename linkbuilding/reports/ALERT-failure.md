# ❌ 01_source run FAILED — 2026-09-20

**Stage:** preflight

```
1a0b64e535dd2aa7: digest declares 6 alert(s) but 5 were parsed. A dropped item is indistinguishable from a quiet day downstream.
```
