...
Round 13 · 213 distinct requests · **2 drafts**
...
| Citations (verified at draft time) | `wl-supp-adulteration`, `wl-supp-efficacy` |
| Claim ids | — |
...
### Mirellé Inspo — `verified_at_draft`
...
| Regime | `verified_at_draft` |
| Framing | `verified-guideline` |
| Citations (verified at draft time) | `biotin-assay-interference`, `biotin-nail-review`, `nail-vitamins` |
| Claim ids | — |
...
## 3 · Ready for Julian's review

_None. No live item is covered by the claim bank or answerable from the experience set alone._
