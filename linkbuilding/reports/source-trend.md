...
| | |
|---|---|
| Runs recorded (locally) | 23 |
| Runs CONFIRMED on the remote | 22 |
| **Days of evidence (verified)** | **6 of 14** |
| Calendar span of local runs | 8 day(s) |
| Digest rows ingested | 455 |
| **Distinct requests** | **370** |
| Answerable (rows) | 37 |
| **Answerable (distinct requests)** | **35** |
| Marginal (rows) | 95 |
| Rejected (rows) | 323 |
...
| 2026-09-22 | 2026-09-22T21:39:36 | 56 | 444 | 97 | 38 | 11 | 93 | 313 | 195 | ⏳ pending |
...
|---|---|---|---|---|---|---|---|---|
| **haro** | 335 | 256 | 26 | **24** | 9.4% | 71 | 238 | direct (`reply+…@helpareporter.com`) |
...
| Day of 14 | **8** |
| HARO digest rows ingested | 335 |
| HARO distinct requests | 256 |
| HARO answerable rows | 26 |
...
|---|---|
| no vocabulary for either expert | 323 |
